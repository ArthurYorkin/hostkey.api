...
namespace common\services\gpuvirtual\models;

use common\services\gpuvirtual\Service;
use common\services\gpuvirtual\base\Gpuvirtual;
use common\services\gpuvirtual\base\GpuvirtualMain;

/**
 * Description of GpuvirtualMainForm
 *
 * @author ArthurYorkin
 */
class GpuvirtualMainForm extends Service
{
    public $location;
    public $groups;
    public $currency;
    ...
    {
        parent::init();
        $this->component = new Gpuvirtual(new GpuvirtualMain($this));
    }
